...
<div style="text-align: center;float:left;width:100%;margin-left: 16px;margin-top: 2%;font-size:15px;display: block;">
<?php
	// BƯỚC 7: HIỂN THỊ PHÂN TRANG
	// nếu current_page > 1 và total_page > 1 mới hiển thị nút prev
	if ($current_page > 1 && $total_page > 1){
	    echo '<a href="Zenith?page='.($current_page-1).'">Trang trước</a> | ';
	}
	//cong day
	$i = 1;
	if ($current_page > 1 ) {
	...
	if ($current_page < $total_page && $total_page > 1){
	    echo '<a href="Zenith?page='.($current_page+1).'">Trang sau</a> ';
	}
?>
</div>
