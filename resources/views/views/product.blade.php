   ...
   <ul class="products">
   	<?php
        ...
        // Có limit và start rồi thì truy vấn CSDL lấy danh sách tin tức
   		...
   		$result = mysqli_query($connect, "SELECT * from sanpham sp,thuonghieu th where sp.thuonghieu = th.mathuonghieu LIMIT $start, $limit");
...
<?php
	...
	if ($current_page > 1 && $total_page > 1){
	    echo '<a href="Product?page='.($current_page-1).'">Trang trước</a> | ';
	}
	//cong day
	$i = 1;
	if ($current_page > 1 ) {
	...
	if ($current_page < $total_page && $total_page > 1){
	    echo '<a href="Product?page='.($current_page+1).'">Trang sau</a> ';
	}
?>
</div>
